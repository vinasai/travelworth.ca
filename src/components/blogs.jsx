                            ...
                            <div className="group relative overflow-hidden" key={index}>
                                ...
                                <div className="mt-6">
                                    <div className="flex mb-4">
                                        ...
                                        <span className="text-slate-400 text-sm ms-3">by <Link to="" className="text-slate-900 dark:text-white hover:text-red-500 dark:hover:text-red-500 font-medium">Travelworth</Link></span>
                                    </div>
