            ...
            <div className="container relative">
                ...
                <div className="menu-extras">
                    <div className="menu-item">
                        <Link to="#" className={`navbar-toggle ${isToggle ? 'open' : ''}`} id="isToggle"
                              onClick={() => toggleMenu()}>
                            <div className="lines">
                                <span></span>
                                <span></span>
                ...
                <div id="navigation" style={{display: isToggle === true ? 'block' : 'none'}}>
                    <ul className={`navigation-menu ${manuclass}`}>
                        <li className={`has-submenu parent-menu-item ${['/', '/index-two', '/index-three', '/index-four', '/index-five', '/index-item'].includes(manu) ? 'active' : ''}`}>
                            <Link to="/"
                                  onClick={() => setSubManu(setManu === '/index-item' ? '' : '/index-item')}>Home</Link>
                            {/*<span*/}
                            ...
                            {/*                                                            className="sub-menu-item">Tour*/}
                            {/*        One</Link></li>*/}
                            {/*    <li className={`${manu === '/index-two' ? 'active' : ''}`}><Link to="/index-two"*/}
                            {/*                                                                     className="sub-menu-item">Tour*/}
                            {/*        Two</Link></li>*/}
                            {/*    <li className={`${manu === '/index-three' ? 'active' : ''}`}><Link to="/index-three"*/}
                            {/*                                                                       className="sub-menu-item">Tour*/}
                            {/*        Three</Link></li>*/}
                            {/*    <li className={`${manu === '/index-four' ? 'active' : ''}`}><Link to="/index-four"*/}
                            {/*                                                                      className="sub-menu-item">Tour*/}
                            {/*        Four</Link></li>*/}
                            {/*    <li className={`${manu === '/index-five' ? 'active' : ''}`}><Link to="/index-five"*/}
                            {/*                                                                      className="sub-menu-item">Tour*/}
                            {/*        Five</Link></li>*/}
                            {/*</ul>*/}
                        </li>
                        <li className={`${manu === '/destination' ? 'active' : ''}`}><Link to="/destination"
                                                                                           className="sub-menu-item">Destination</Link>
                        </li>
                        ...
                        <li className={`has-submenu parent-parent-menu-item ${['/page-item', '/aboutus', '/user-item', '/user-profile', '/user-billing', '/user-payment', '/user-invoice', '/user-social', '/user-notification', '/user-setting', '/help-item', '/helpcenter', '/helpcenter-faqs', '/helpcenter-guides', '/helpcenter-support', '/auth-item', '/login', '/signup', '/forgot-password', '/lock-screen', '/utility-item', '/terms', '/privacy', '/special-item', '/comingsoon', '/maintenance', '/404'].includes(manu) ? 'active' : ''}`}>
                            <Link to="/aboutus"
                                  onClick={() => setSubManu(subManu === '/aboutus' ? '' : '/page-item')}>About</Link>
                            {/*<span*/}
                            {/*className="menu-arrow"></span>*/}
                            {/*<ul className={`submenu ${['/page-item', '/aboutus', '/user-item', '/user-profile', '/user-billing', '/user-payment', '/user-invoice', '/user-social', '/user-notification', '/user-setting', '/help-item', '/helpcenter', '/helpcenter-faqs', '/helpcenter-guides', '/helpcenter-support', '/auth-item', '/login', '/signup', '/forgot-password', '/lock-screen', '/utility-item', '/terms', '/privacy', '/special-item', '/comingsoon', '/maintenance', '/404'].includes(subManu) ? 'open' : ''}`}>*/}
                                ...
                                {/*<li className={`has-submenu parent-menu-item ${['/user-item', '/user-profile', '/user-billing', '/user-payment', '/user-invoice', '/user-social', '/user-notification', '/user-setting'].includes(manu) ? 'active' : ''}`}>*/}
                                {/*    <Link to=""*/}
                                {/*          onClick={() => setSubManu(subManu === '/user-item' ? '' : '/user-item')}> My*/}
                                {/*        Account</Link><span className="submenu-arrow"></span>*/}
                                ...
                                {/*        <li className={`${manu === '/user-profile' ? 'active' : ''}`}><Link*/}
                                {/*            to="/user-profile" className="sub-menu-item">User Account</Link></li>*/}
                                {/*        <li className={`${manu === '/user-payment' ? 'active' : ''}`}><Link*/}
                                {/*            to="/user-payment" className="sub-menu-item">Payment</Link></li>*/}
                                {/*        <li className={`${manu === '/user-invoice' ? 'active' : ''}`}><Link*/}
                                {/*            to="/user-invoice" className="sub-menu-item">Invoice</Link></li>*/}
                                {/*        <li className={`${manu === '/user-social' ? 'active' : ''}`}><Link*/}
                                {/*            to="/user-social" className="sub-menu-item">Social</Link></li>*/}
                                {/*        <li className={`${manu === '/user-notification' ? 'active' : ''}`}><Link*/}
                                {/*            to="/user-notification" className="sub-menu-item">Notification</Link></li>*/}
                                {/*        <li className={`${manu === '/user-setting' ? 'active' : ''}`}><Link*/}
                                {/*            to="/user-setting" className="sub-menu-item">Setting</Link></li>*/}
                                {/*    </ul>*/}
                                {/*</li>*/}
                                ...
                                {/*    <Link to=""*/}
                                {/*          onClick={() => setSubManu(subManu === '/help-item' ? '' : '/help-item')}>Helpcenter </Link><span*/}
                                {/*    className="submenu-arrow"></span>*/}
                                {/*    <ul className={`submenu ${['/help-item', '/helpcenter', '/helpcenter-faqs', '/helpcenter-guides', '/helpcenter-support'].includes(subManu) ? 'open' : ''}`}>*/}
                                {/*        <li className={`${manu === '/helpcenter' ? 'active' : ''}`}><Link*/}
                                {/*            to="/helpcenter" className="sub-menu-item">Overview</Link></li>*/}
                                {/*        <li className={`${manu === '/helpcenter-faqs' ? 'active' : ''}`}><Link*/}
                                {/*            to="/helpcenter-faqs" className="sub-menu-item">FAQs</Link></li>*/}
                                {/*        <li className={`${manu === '/helpcenter-guides' ? 'active' : ''}`}><Link*/}
                                {/*            to="/helpcenter-guides" className="sub-menu-item">Guides</Link></li>*/}
                                {/*        <li className={`${manu === '/helpcenter-support' ? 'active' : ''}`}><Link*/}
                                {/*            to="/helpcenter-support" className="sub-menu-item">Support</Link></li>*/}
                                {/*    </ul>*/}
                                {/*</li>*/}

                                {/*<li className={`has-submenu parent-menu-item ${['/auth-item', '/login', '/signup', '/forgot-password', '/lock-screen'].includes(manu) ? 'active' : ''}`}>*/}
                                {/*    <Link to=""*/}
                                {/*          onClick={() => setSubManu(subManu === '/auth-item' ? '' : '/auth-item')}> Auth*/}
                                {/*        Pages </Link><span className="submenu-arrow"></span>*/}
                                ...
                                {/*        <li><Link to="/forgot-password" className="sub-menu-item"> Forgot*/}
                                {/*            Password</Link></li>*/}
                                {/*        <li><Link to="/lock-screen" className="sub-menu-item"> Lock Screen</Link></li>*/}
                                {/*    </ul>*/}
                                {/*</li>*/}

                                {/*<li className={`has-submenu parent-menu-item ${['/utility-item', '/terms', '/privacy'].includes(manu) ? 'active' : ''}`}>*/}
                                {/*    <Link to=""*/}
                                {/*          onClick={() => setSubManu(subManu === '/utility-item' ? '' : '/utility-item')}> Utility </Link><span*/}
                                {/*    className="submenu-arrow"></span>*/}
                                {/*    <ul className={`submenu ${['/utility-item', '/terms', '/privacy'].includes(subManu) ? 'open' : ''}`}>*/}
                                {/*        <li className={`${manu === '/terms' ? 'active' : ''}`}><Link to="/terms"*/}
                                {/*                                                                     className="sub-menu-item">Terms*/}
                                {/*            of Services</Link></li>*/}
                                {/*        <li className={`${manu === '/privacy' ? 'active' : ''}`}><Link to="/privacy"*/}
                                {/*                                                                       className="sub-menu-item">Privacy*/}
                                {/*            Policy</Link></li>*/}
                                {/*    </ul>*/}
                                {/*</li>*/}

                                {/*<li className={`has-submenu parent-menu-item ${['/special-item', '/comingsoon', '/maintenance', '/404'].includes(manu) ? 'active' : ''}`}>*/}
                                {/*    <Link to=""*/}
                                {/*          onClick={() => setSubManu(subManu === '/special-item' ? '' : '/special-item')}> Special </Link><span*/}
                                {/*    className="submenu-arrow"></span>*/}
                        ...
                        {/* <li className={`has-submenu parent-menu-item ${['/blogs', '/blog-standard', '/blog-detail', '/blog-item'].includes(manu) ? 'active' : ''}`}> */}
                        {/* <Link to="" onClick={() => setSubManu(subManu === '/blog-item' ? '' : '/blog-item')}>Destination</Link><span className="menu-arrow"></span> */}
                        {/* <ul className={`submenu ${['/blogs', '/blog-standard', '/blog-detail', '/blog-item'].includes(subManu) ? 'open' : ''}`}>
                                <li className={`${manu === '/blogs' ? 'active' : ''}`}><Link to="/blogs" className="sub-menu-item"> Blogs</Link></li>
                                <li className={`${manu === '/blog-standard' ? 'active' : ''}`}><Link to="/blog-standard" className="sub-menu-item"> Blog Standard</Link></li>
                                <li className={`${manu === '/blog-detail' ? 'active' : ''}`}><Link to="/blog-detail" className="sub-menu-item"> Blog Detail</Link></li>
                        ...
                        <li className={`${manu === '/contact' ? 'active' : ''}`}><Link to="/contact"
                                                                                       className="sub-menu-item">Contact
                            Us</Link></li>
                    </ul>
                </div>
            </div>
