          ...
          <div className="grid md:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px]">
            <div className="lg:col-span-8 md:col-span-7 md:order-1 order-2">
              ...
              <h4 className="font-bold text-white lg:leading-normal leading-normal text-4xl lg:text-6xl mb-6 mt-5">
                Let's Leave The Road, <br /> And Take Travelworth
              </h4>
              ...
              <button className="call-us-button flex flex-row bg-white hover:bg-gray-200 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded-xl shadow">
                <div>
                  <h2 className="text-2xl font-semibold text-slate-900 dark:text-white m-2 ">
                    Call Us |{" "}
                  </h2>
                </div>
                <div className="flex items-center justify-center space-x-2">
                  ...
                  <a
                    href="tel:4167543833"
                    className="text-red-500 text-2xl font-bold pt-2"
                  >
                    +14167543833
                  </a>
                </div>
        ...
        <div className="container relative md:mt-24 mt-16">
                  ...
                  <div className="p-4">
                    ...
                    <div className="mt-4 pt-4 flex justify-between items-center border-t border-slate-100 dark:border-gray-800">
                      <h5 className="text-lg font-medium text-red-500">
                        ${" "}
                        {/* Notification for new contact {item.price} / Day */}
                      </h5>
          ...
          <div className="mt-6 text-center">
            <Link
              ...
              className="text-slate-400 hover:text-red-500 inline-block text-lg"
            >
              See More Tours{" "}
